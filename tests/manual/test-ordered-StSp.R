test_that("test the estimation of state space system for ordered probit models", {
  mod <- mod_StSp_cl$new(
    alt = 3,
  ...
  # system matrices
  theta_0 <- c(1, 0, 1, 0, 0.2, 1, 0.5, 1, 1) + rnorm(9) * 0.05
  syst <- build_system_from_model_R(theta_0, mod, time)
  tauk <- syst$tauk
